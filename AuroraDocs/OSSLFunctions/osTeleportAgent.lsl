...
//
// Script Title:    osTeleportAgent.lsl
...
//    osTeleportAgent(string agent, int regionX, int regionY, vector position, vector lookat);
//    osTeleportAgent(string agent, string regionName, vector position, vector lookat);
//    osTeleportAgent(string agent, vector position, vector lookat);
//    osTeleportAgent(string agent, string Ip_or_DNS:Port:RegionName, vector lookat);
//
