...
CREATE TABLE assetMediaURL (objectUUID VARCHAR(100),User VARCHAR(100), alt_image_enable VARCHAR(100), auto_loop VARCHAR(100), auto_play VARCHAR(100), auto_scale VARCHAR(100), auto_zoom VARCHAR(100), controls VARCHAR(100), current_url VARCHAR(100), first_click_interact VARCHAR(100), height_pixels VARCHAR(100), home_url VARCHAR(100), perms_control VARCHAR(100), whitelist_enable VARCHAR(100), width_pixels VARCHAR(100), object_media_version VARCHAR(100), PRIMARY KEY (object_media_version, objectUUID) );
