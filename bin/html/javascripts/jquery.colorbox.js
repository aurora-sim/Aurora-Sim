...
(function ($, document, window) {
	...
	defaults = {
		...
		opacity: 0.9,
		preloading: true,
		current: "{ColorBoxImageText} {current} {ColorBoxOfText} {total}",
		previous: " {ColorBoxPreviousText}",
		next: "{ColorBoxNextText} ",
		close: "{ColorBoxCloseText}",
		open: false,
		returnFocus: true,
		loop: true,
		slideshow: false,
		slideshowAuto: true,
		slideshowSpeed: 2500,
		slideshowStart: "{ColorBoxStartSlideshowText}",
		slideshowStop: "{ColorBoxStopSlideshowText}",					
		onOpen: false,
		onLoad: false,
		onComplete: false,
		onCleanup: false,
