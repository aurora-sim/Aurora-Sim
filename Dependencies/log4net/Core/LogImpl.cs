...
namespace log4net.Core
{
	...
	public class LogImpl : LoggerWrapperImpl, ILog
	{
        ...
        /// <para>
        /// This way you will not incur the cost of parameter
        /// construction if tracing is disabled for <c>log</c>. On
        /// the other hand, if the <c>log</c> is trace enabled, you
        /// will incur the cost of evaluating whether the logger is debug
        /// enabled twice. Once in <c>IsTraceEnabled</c> and once in
        ...
        /// <summary>
        /// Checks if this logger is enabled for the given level.
        /// </summary>
        /// <value>
        /// <c>true</c> if this logger is enabled for the given events,
        /// <c>false</c> otherwise.
        /// </value>
        /// <remarks>
        /// <para>
        ...
        /// </remarks>
        /// <seealso cref="ILog.IsDebugEnabled"/>
        virtual public bool IsEnabled(Level level)
        {
        ...
        /// </para>
        /// </remarks>
        virtual public void Log(Level level, object message)
        {
            if (IsEnabled(level))
            {
        ...
        /// </para>
        /// </remarks>
        virtual public void Format(Level level, string format, params object[] args)
        {
            if (IsEnabled(level))
            {
                Logger.Log(ThisDeclaringType, level, new SystemStringFormat(CultureInfo.InvariantCulture, format, args), null);
            }
        }
        ...
        /// </para>
        /// </remarks>
        virtual public void Format(Level level, string format, object arg0)
        {
            if (IsEnabled(level))
            {
                Logger.Log(ThisDeclaringType, level, new SystemStringFormat(CultureInfo.InvariantCulture, format, new object[] { arg0 }), null);
            }
        }
        ...
        /// </para>
        /// </remarks>
        virtual public void Format(Level level, string format, object arg0, object arg1)
        {
            if (IsEnabled(level))
            {
                Logger.Log(ThisDeclaringType, level, new SystemStringFormat(CultureInfo.InvariantCulture, format, new object[] { arg0, arg1 }), null);
            }
        }
        ...
        /// </para>
        /// </remarks>
        virtual public void Format(Level level, string format, object arg0, object arg1, object arg2)
        {
            if (IsEnabled(level))
            {
                Logger.Log(ThisDeclaringType, level, new SystemStringFormat(CultureInfo.InvariantCulture, format, new object[] { arg0, arg1, arg2 }), null);
            }
        }
        ...
        /// </para>
        /// </remarks>
        virtual public void Format(Level level, IFormatProvider provider, string format, params object[] args)
        {
            if (IsEnabled(level))
            {
                Logger.Log(ThisDeclaringType, level, new SystemStringFormat(provider, format, args), null);
            }
        }
