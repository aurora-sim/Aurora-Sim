...
namespace HttpServer.MVC.Rendering
{
    ...
    public class TemplateManager
    {
        ...
        /// <summary>
        /// Find a template using wild cards in filename.
        /// </summary>
        /// <param name="filePath">Full path (including wild cards in filename) to where we should find a template.</param>
        ...
        /// <exception cref="InvalidOperationException">Failed to find path in filename.</exception>
