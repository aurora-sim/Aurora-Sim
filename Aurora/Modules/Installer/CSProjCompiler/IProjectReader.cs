...
namespace RunTimeCompiler
{
    ...
    public interface IProjectReader
    {
        ...
        ///   will be successfull.
        /// </summary>
        /// <param name = "filename">The name of the project file. It should include 
        ///   path (absolute or relative).</param>
        /// <returns>True if the project-reader "beleaves" he can read the project 
        ///   file.</returns>
