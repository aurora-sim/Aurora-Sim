    ...
    public class AuroraMigrator_2010_03_13 : Migrator
    {
        public AuroraMigrator_2010_03_13()
        {
            ...
            AddSchema("regionwindlight", ColDefs(
                ...
                ColDef("water_color_b", ColumnTypes.String50, true),
                ColDef("water_fog_density_exponent", ColumnTypes.String50, true),
                ColDef("underwater_fog_modifier", ColumnTypes.String50, true),
                ColDef("reflection_wavelet_scale_1", ColumnTypes.String50, true),
                ColDef("reflection_wavelet_scale_2", ColumnTypes.String50, true),
                ColDef("reflection_wavelet_scale_3", ColumnTypes.String50, true),
                ColDef("fresnel_scale", ColumnTypes.String50, true),
                ColDef("fresnel_offset", ColumnTypes.String50, true),
                ColDef("refract_scale_above", ColumnTypes.String50, true),
                ColDef("refract_scale_below", ColumnTypes.String50, true),
                ColDef("blur_multiplier", ColumnTypes.String50, true),
                ColDef("big_wave_direction_x", ColumnTypes.String50, true),
                ColDef("big_wave_direction_y", ColumnTypes.String50, true),
                ColDef("little_wave_direction_x", ColumnTypes.String50, true),
                ColDef("little_wave_direction_y", ColumnTypes.String50, true),
                ColDef("normal_map_texture", ColumnTypes.String50, true),
                ColDef("horizon_r", ColumnTypes.String50, true),
                ColDef("horizon_g", ColumnTypes.String50, true),
                ColDef("horizon_b", ColumnTypes.String50, true),
                ColDef("horizon_i", ColumnTypes.String50, true),
                ColDef("haze_horizon", ColumnTypes.String50, true),
                ColDef("blue_density_r", ColumnTypes.String50, true),
                ColDef("blue_density_g", ColumnTypes.String50, true),
                ColDef("blue_density_b", ColumnTypes.String50, true),
                ColDef("blue_density_i", ColumnTypes.String50, true),
                ColDef("haze_density", ColumnTypes.String50, true),
                ColDef("density_multiplier", ColumnTypes.String50, true),
                ColDef("distance_multiplier", ColumnTypes.String50, true),
                ColDef("max_altitude", ColumnTypes.String50, true),
                ColDef("sun_moon_color_r", ColumnTypes.String50, true),
                ColDef("sun_moon_color_g", ColumnTypes.String50, true),
                ColDef("sun_moon_color_b", ColumnTypes.String50, true),
                ColDef("sun_moon_color_i", ColumnTypes.String50, true),
                ColDef("sun_moon_position", ColumnTypes.String50, true),
                ColDef("ambient_r", ColumnTypes.String50, true),
                ColDef("ambient_g", ColumnTypes.String50, true),
                ColDef("ambient_b", ColumnTypes.String50, true),
                ColDef("ambient_i", ColumnTypes.String50, true),
                ColDef("east_angle", ColumnTypes.String50, true),
                ColDef("sun_glow_focus", ColumnTypes.String50, true),
                ColDef("sun_glow_size", ColumnTypes.String50, true),
                ColDef("scene_gamma", ColumnTypes.String50, true),
                ColDef("star_brightness", ColumnTypes.String50, true),
                ColDef("cloud_color_r", ColumnTypes.String50, true),
                ColDef("cloud_color_g", ColumnTypes.String50, true),
                ColDef("cloud_color_b", ColumnTypes.String50, true),
                ColDef("cloud_color_i", ColumnTypes.String50, true),
                ColDef("cloud_x", ColumnTypes.String50, true),
                ColDef("cloud_y", ColumnTypes.String50, true),
                ColDef("cloud_density", ColumnTypes.String50, true),
                ColDef("cloud_coverage", ColumnTypes.String50, true),
                ColDef("cloud_scale", ColumnTypes.String50, true),
                ColDef("cloud_detail_x", ColumnTypes.String50, true),
                ColDef("cloud_detail_y", ColumnTypes.String50, true),
                ColDef("cloud_detail_density", ColumnTypes.String50, true),
                ColDef("cloud_scroll_x", ColumnTypes.String50, true),
                ColDef("cloud_scroll_x_lock", ColumnTypes.String50, true),
                ColDef("cloud_scroll_y", ColumnTypes.String50, true),
                ColDef("cloud_scroll_y_lock", ColumnTypes.String50, true),
                ColDef("draw_classic_clouds", ColumnTypes.String50, true)
               ));
        }
