...
namespace Aurora.DataManager.Migration.Migrators
{
    public class AuroraMigrator_2010_03_13 : Migrator
    {
        public AuroraMigrator_2010_03_13()
        {
            ...
            AddSchema("landinfo", ColDefs(ColDef("RegionID", ColumnTypes.String50), ColDef("ParcelID", ColumnTypes.String50, true), ColDef("LocalID", ColumnTypes.String50), ColDef("LandingX", ColumnTypes.String50), ColDef("LandingY", ColumnTypes.String50), ColDef("LandingZ", ColumnTypes.String50), ColDef("Name", ColumnTypes.String50), ColDef("Description", ColumnTypes.String50), ColDef("Flags", ColumnTypes.String50), ColDef("Dwell", ColumnTypes.String50), ColDef("InfoUUID", ColumnTypes.String50), ColDef("ForSale", ColumnTypes.String50), ColDef("AuctionID", ColumnTypes.String50), ColDef("Area", ColumnTypes.String50), ColDef("EstateID", ColumnTypes.String50), ColDef("Maturity", ColumnTypes.String50), ColDef("OwnerID", ColumnTypes.String50), ColDef("GroupID", ColumnTypes.String50), ColDef("MediaDescription", ColumnTypes.String50), ColDef("MediaHeight", ColumnTypes.String50), ColDef("MediaWidth", ColumnTypes.String50), ColDef("MediaLoop", ColumnTypes.String50), ColDef("MediaType", ColumnTypes.String50), ColDef("ObscureMedia", ColumnTypes.String50), ColDef("ObscureMusic", ColumnTypes.String50), ColDef("ShowInSearch", ColumnTypes.String50)));
